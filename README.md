Ender Veiga Bueno - Proyecto fin de ciclo: Searchy

Nota: para ejecutar la aplicación, es necesario tener Node.js instalado
y ejecutar "npm install" en un terminal desde la raíz del proyecto

Desde un terminal ubicado en la raíz del proyecto, ejecuta "npm start",
y accede a la página desde cualquier navegador en http://localhost:3000/

Se puede probar el funcionamiento de la aplicación mediante peticiones GET a
